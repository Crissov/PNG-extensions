...
Conceptually, at the beginning of each play the output buffer must be completely initialized to a fully transparent black rectangle, with _width_ and _height_ dimensions from the `IHDR` chunk.
